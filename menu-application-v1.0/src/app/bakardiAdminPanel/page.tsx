...
export default function BakardiAdminPanel() {
  ...
  useEffect(() => {
    const loggedIn = localStorage.getItem("bakardiAdminLoggedIn");
    if (loggedIn !== "true") {
      router.replace("/bakardiAdminLogin");
    }
  }, [router]);
    ...
    <div className="p-10">
      <div className="flex">
        <h1 className="text-3xl font-bold mb-6">
          Добредојдовте во Админ Панелот
        </h1>
      </div>
      <button className="bg-red-600">Одјави се</button>
